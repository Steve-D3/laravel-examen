    ...
    <div
        ...
        <main class="flex max-w-[600px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-2xl">Welcome to Canada Trips</h1>
                <p class="mb-6 text-[#706f6c] dark:text-[#A1A09A]">Your gateway to amazing Canadian adventures.
                    <br>Explore the beauty of Canada with our curated trips across this magnificent country.
                </p>

                <div class="mb-8">
                    <h2 class="text-lg font-medium mb-4">Featured Trips</h2>
                    <div class="grid gap-4 mb-6">
                        <div
                            class="flex items-center gap-4 p-4 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg">
                            <i class="fas fa-mountain text-blue-500 text-xl"></i>
                            <div>
                                <h3 class="font-medium">Rocky Mountain Explorer</h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">7 days of breathtaking mountain
                                    views</p>
                            </div>
                        </div>
                        <div
                            ...
                            <div>
                                <h3 class="font-medium">East Coast Adventure</h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">10 days exploring the Atlantic
                                    provinces</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-4">
                    <h2 class="text-lg font-medium">Admin Access</h2>
                    <p class="text-[#706f6c] dark:text-[#A1A09A] mb-4">Manage trips, view bookings, and track revenue
                        with our admin dashboard.</p>
            ...
            <div
                ...
                <div
                    class="absolute inset-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] overflow-hidden object-cover">
                    <img src="https://media.istockphoto.com/id/944254900/vector/summer-retpo-poster.jpg?s=612x612&w=0&k=20&c=jPioNtUhGNTKmwFWAb9Cqc5x79I87QNVUfsVY7ovL-s="
                        alt="Canada Travel" class="w-full h-full object-cover" loading="lazy">
                </div>
            </div>
        </main>
    </div>
